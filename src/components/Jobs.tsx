    ...
    >
      ...
      >
        ...
        <div style={{ padding: "24px" }}>
          ...
          <div style={{ borderTop: `1px solid ${theme.colors.border}`, paddingTop: "20px", display: "flex", gap: "12px" }}>
            <button
              onClick={onClose}
              style={{
                flex: 1,
            ...
            <button
              ...
              style={{
                ...
                fontSize: "14px",
                fontWeight: "600",
                cursor: !formData.title.trim() || isLoading ? "not-allowed" : "pointer",
            ...
            >
              {isLoading ? <Loader2 size={16} style={{ animation: "spin 1s linear infinite" }} /> : <Plus size={16} />}
              Create Job
            </button>
          </div>
        </div>
